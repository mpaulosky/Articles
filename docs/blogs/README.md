...
- [v0.1.8: Test Coverage Expansion and Build Cleanup](2026-08-20-v0.1.8-test-coverage-expansion.md)
- [v0.1.7: Code Coverage Tooling and Analysis Cleanup](2026-08-20-v0.1.7-code-coverage-analysis-warnings.md)
- [v0.1.4: Article and Category Management Features](2026-08-20-v0.1.4-article-category-management.md)
- [v0.1.3: UI Test Reorganization and Demo Cleanup](2026-08-20-v0.1.3-ui-test-reorganization.md)
- [v0.1.1: MongoDB Data Layer Implementation](2026-08-19-v0.1.1-mongodb-data-layer.md)
- [v0.0.5: Auth0 Integration and Stability](2026-08-18-v0.0.5-auth0-integration.md)
...
### Infrastructure
- [v0.1.5: Custom Mediator Pipeline and Navigation Links](2026-08-20-v0.1.5-custom-mediator-navigation.md)
- [v0.1.1: MongoDB Data Layer Implementation](2026-08-19-v0.1.1-mongodb-data-layer.md)
- [v0.0.6: Domain Refactoring Preparation](2026-08-19-v0.0.6-domain-refactoring-prep.md)
- [v0.0.5: Auth0 Integration and Stability](2026-08-18-v0.0.5-auth0-integration.md)
...
### Features
- [v0.1.6: Populate Article Author from Logged-In User](2026-08-20-v0.1.6-author-from-logged-in-user.md)
- [v0.1.4: Article and Category Management Features](2026-08-20-v0.1.4-article-category-management.md)
...
- **v0.1.5**: Custom mediator pipeline and navigation links
- **v0.1.4**: Article and category management features
- **v0.1.3**: UI test reorganization and Counter demo cleanup
- **v0.1.2**: Backfilled release blog documentation
