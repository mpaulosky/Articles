...
| UI/Web/Blazor development            | Simon        | Blazor components, pages, layouts, responsive UI, accessibility   |
...
3. **Before any push-ready handoff**, route through the pre-push gate skill and
   ...
   branch naming, Release build, `Architecture.Tests`, `AppHost.Tests`, and
   `Integration.Tests`.
...
10. **When any production code is written or modified** (Domain, Web, Persistence,
    ...
    (currently 89% line threshold in `AppHost.Tests.csproj`) must pass locally before
